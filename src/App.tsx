...
const App: React.FC = () => {
  ...
  const [activeView, setActiveView] = useState<'team' | 'table' | 'transfers' | 'matches' | 'stadium'>('team');
        ...
        <>
          <nav className="bg-blue-600 text-white p-4">
            <div className="max-w-7xl mx-auto flex gap-4 flex-wrap">
              ...
              <button onClick={() => setActiveView('table')} className={activeView === 'table' ? 'font-bold' : ''}>Ligatabel</button>
          ...
          <main className="max-w-7xl mx-auto px-4 py-8">
            ...
            {activeView === 'table' && <LeagueTableView />}
